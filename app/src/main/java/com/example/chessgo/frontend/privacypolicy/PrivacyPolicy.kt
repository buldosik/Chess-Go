package com.example.chessgo.frontend.privacypolicy
...
/**
 * PrivacyPolicy screen to display the privacy policy information.
 *
 * @param navController NavHostController for navigation.
 */
@Composable
fun PrivacyPolicy(navController: NavHostController = rememberNavController()){
